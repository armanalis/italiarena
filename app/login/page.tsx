...
const loginErrors: Record<string, string> = {
  auth_callback_failed: `Sign-in link did not complete. In Supabase → Authentication → URL configuration, set Site URL to ${getProductionSiteUrl()}, add ${getProductionSiteUrl()}/auth/callback to Redirect URLs, and remove any old language-quiz-one.vercel.app or quiz-one.vercel.app entries. Then try again. You can still sign in with email or username.`,
